...
(default, 2, 'Into the Wild', 'book2', 520, 46, 5, true, 1),
(default, 2, 'The Last Stand', 'book3', 300, 21, 0, true, 1),
(default, 3, 'Secrets of the Forest', 'book1', 120, 2, 0, true, 1),
(default, 3, 'Whispers in the Wind', 'book2', 200, 20, 1, true, 1),
...
(default, 5, 'Broken Promises', 'book2', 320, 20, 4, true, 1),
...
(default, 8, 'The Final Hour', 'book3', 500, 60, 4, true, 1),
...
(default, 10, 'Guardians of Time', 'book3', 1000, 20, 4, true, 1),
...
(default, 14, 'The Forgotten Realm', 'book1', 300, 20, 3, true, 1),
(default, 14, 'Legacy of the Ancients', 'book1', 200, 45, 0, true, 1),
(default, 15, 'The Lost Heirloom', 'book1', 600, 14, 0, true, 1),
(default, 15, 'Whispers in the Dark', 'book2', 1000, 11, 1, true, 1),
...
(default, 19, 'The Enchanted Forest', 'book3', 600, 50, 2, true, 1),
(default, 19, 'The Hidden Path', 'book2', 320, 30, 0, true, 1),
(default, 20, 'The Lost Treasure', 'book2', 200, 23, 0, true, 1),
(default, 20, 'Echoes of the Past', 'book1', 500, 24, 5, true, 1);
